...
<x-modal name="{{ $idea->exists ? 'edit-idea' : 'create-idea' }}"
    ...
    <form x-data="{
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                @if ($idea->image_path)
                    <div class="space-y-2">
                        ...
                        <button class="btn btn-outlined h-10" form="delete-image-form">Remove Image</button>
                    </div>
                @endif
            ...
            <div>
                <fieldset class="space-y-3 fieldset">
                    ...
                    <div class="flex gap-x-5 items-center">
                        ...
                        <button type="button"
                            ...
                            :disabled="newStep.trim().length === 0" aria-label="Add new step" class="form-muted-icon">
            ...
            <div>
                <fieldset class="space-y-3 fieldset mt-2">
                    ...
                    <div class="flex gap-x-5 items-center">
                        ...
                        <button type="button" @click="links.push(newLink.trim()); newLink = '';"
                            :disabled="newLink.trim().length === 0" aria-label="Add new link" class="form-muted-icon">
                            <x-icons.close class="rotate-45" />
                        </button>
                    </div>
            ...
            <div class="flex justify-end gap-x-5 mt-4">
                <button type="button" class="text-red-600" @click="$dispatch('close-modal')">Cancel</button>
